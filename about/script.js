...
document.getElementById("createForm").addEventListener("submit", function (event) {
  ...
  console.log("Create Password - Name: " + passwordName + ", Value: " + passwordValue);
});

document.getElementById("deleteForm").addEventListener("submit", function (event) {
  event.preventDefault();
  var deletePasswordName = document.getElementById("deletePasswordName").value;
...
document.getElementById("updateForm").addEventListener("submit", function (event) {
  event.preventDefault();
  var updatePasswordName = document.getElementById("updatePasswordName").value;
  ...
  console.log("Update Password - Name: " + updatePasswordName + ", New Value: " + newPasswordValue);
